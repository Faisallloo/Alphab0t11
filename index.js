...
var nomor_dana = `Gopay Aja kak` //gk usah di ubah ya klo gk punya ntr eror
...
`
if(menusimple == false){
sendButDoc(from, ini_anu, `*JANGAN SPAM BOT , TUNGGU 5DETIK UNTUK COMMAND LAINNYA*.\nFaisal!`, sender, koko, ini_mark)
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} itu owner ku, jangan lupa donasi untuK Faisal🤗`
var buttonss = [
